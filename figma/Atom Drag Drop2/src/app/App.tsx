...
import { TeamAssignDragDrop } from './components/TeamAssignDragDrop';
import { WorkItemTeamDragDrop } from './components/WorkItemTeamDragDrop';
    ...
    <DndProvider backend={HTML5Backend}>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-6">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          {/* Team Assignment - Individuals */}
          <Card className="bg-white/70 backdrop-blur-sm border-0 shadow-lg">
            <CardHeader>
              <div className="flex items-center gap-2">
                <Badge variant="outline" className="px-3 py-1 bg-emerald-100 border-emerald-400 text-emerald-700">
              ...
              <CardDescription className="text-slate-600">
                Drag people from the roster onto a team — they move across panels, preserving their roles and skills
              </CardDescription>
            </CardHeader>
            <CardContent>
              <TeamAssignDragDrop />
          ...
          {/* Team Assignment - Work Items */}
          <Card className="bg-white/70 backdrop-blur-sm border-0 shadow-lg">
            <CardHeader>
              <div className="flex items-center gap-2">
                <Badge variant="outline" className="px-3 py-1 bg-violet-100 border-violet-400 text-violet-700">
                  <Move className="h-3 w-3 mr-1" />
              ...
              <CardDescription className="text-slate-600">
                Drag sprint backlog items onto teams — filter by type, track point distribution across squads
              </CardDescription>
            </CardHeader>
            <CardContent>
              <WorkItemTeamDragDrop />
            </CardContent>
          </Card>
