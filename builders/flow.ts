...
function renderSankey(svgEl: SVGSVGElement, data: FlowData, metadata: Record<string, any>, onEvent?: OnSafeEvent): void {
    ...
    svg.append("g")
        ...
        .on("click", (_, d: any) => linkEvent(onEvent, data.nodes[d.source.index]?.name, data.nodes[d.target.index]?.name, d.value));
    ...
    svg.append("g")
        ...
        .attr("rx", 3)
        .style("cursor", "pointer")
        .on("click", (_, d: any) => nodeEvent(onEvent, data.nodes[d.index]?.name));
...
function renderChord(svgEl: SVGSVGElement, data: FlowData, metadata: Record<string, any>, onEvent?: OnSafeEvent): void {
    ...
    g.append("g")
        ...
        .style("cursor", "pointer")
        .on("click", (_, d) => nodeEvent(onEvent, names[d.index]));
    ...
    g.append("g")
        ...
        .style("cursor", "pointer")
        .on("click", (_, d) => linkEvent(onEvent, names[d.source.index], names[d.target.index], matrix[d.source.index][d.target.index]));
...
function renderForce(svgEl: SVGSVGElement, data: FlowData, metadata: Record<string, any>, onEvent?: OnSafeEvent): void {
    ...
    svg.append("g")
        ...
        .style("cursor", "pointer")
        .on("click", (_, d: any) => linkEvent(onEvent, d.source.name, d.target.name, d.value));
    ...
    svg.append("g")
        ...
        .style("cursor", "pointer")
        .on("click", (_, d: any) => nodeEvent(onEvent, d.name));
...
function renderArc(svgEl: SVGSVGElement, data: FlowData, metadata: Record<string, any>, onEvent?: OnSafeEvent): void {
    ...
    svg.append("g")
        ...
        .style("cursor", "pointer")
        .on("click", (_, d) => linkEvent(onEvent, d.source, d.target, d.value));
    ...
    svg.append("g")
        ...
        .style("cursor", "pointer")
        .on("click", (_, d) => nodeEvent(onEvent, d.name));
