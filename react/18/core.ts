 ...
 */
export * from "../../../safecontracts/src/contracts-emit";
...
export { createDispatcher, dispatchEvent } from "../../../safecontracts/src/dispatcher";
export type { Dispatcher, DispatchContext, EventFires, EventShape, EventShapeMap } from "../../../safecontracts/src/dispatcher";
