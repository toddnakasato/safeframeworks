/**
 * DragDrop builder for this renderer's SafeDragDrop — pure drag-and-drop.
 *
 * Framework-agnostic DOM port of the react SafeDragDrop implementation:
...
/** Build the drag-drop into a container. Returns the root for removal. */
...
/**
 * Scan-and-mount for server-rendered hosts (Astro): build a drag-drop in
 * every div[data-dragdrop-config] not yet mounted.
 */
