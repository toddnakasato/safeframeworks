/**
 * Table builder for this renderer's SafeTable — config-driven table.
 *
 * Framework-agnostic DOM port of the react SafeTable implementation:
 * sorting, paging, selection, drag-reorder, footer summary, pagination.
 *
 ...
 * covers both. Events: "sort", "row:click", "row:select", "reorder", "page".
 */
...
/** Build the table into a container. Returns the root for removal. */
...
/**
 * Scan-and-mount for server-rendered hosts (Astro): build a table in every
 * div[data-table-config] not yet mounted.
 */
