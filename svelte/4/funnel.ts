/**
 * Funnel builder for this renderer's SafeFunnel — D3 funnel/conversion bars.
 *
 * Framework-agnostic DOM port of the react JSX implementation:
 * centered animated bars + labels + value/percent + inter-stage conversion.
 *
...
/** Build the funnel into a container. Returns the root for removal. */
...
/**
 * Scan-and-mount for server-rendered hosts (Astro): build a funnel in every
 * div[data-funnel-config] not yet mounted.
 */
